...
public class prodiReport extends JFrame{
    public JPanel panelProdiReport;
    private JTable tblProdiReport;
    ...
    public prodiReport() {
        ...
        setContentPane(panelProdiReport);
        ...
        tblProdiReport.setModel(tableModel);
        addColumn();
